...
const toLastNames = (people) => {
  // Solution code here...
  let totalNAme = people.map((person) => {
...
const addPurchases = (arr) => {
  // Solution code here...
  let sumPurchased = arr.reduce((total, item) => {
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let count = arr.reduce((a, b, c, array) => {
    return array.length;
  });
  return count;
};
...
const returnNames = (arr) => {
  // Solution code here...
  let arrayName = arr.reduce((groupName, item, index) => {
    // (groupName + "," + item.name).split(",");
    groupName[index] = item.name;
    return groupName;
  }, []);
  return arrayName;
};
